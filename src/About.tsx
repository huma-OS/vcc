      ...
      <div className="slide-models about about-content-wrapper">
        ...
        <div className="tech-stack-icons">
            ...
            />
             <img
              className="tech-icon"
              src="img/icons/node-dot-js.svg"
              alt="node-dot-js"
            />
            <img
              className="tech-icon"
              src="img/icons/next-dot-js.svg"
              alt="next-dot-js"
            />
            <img
              className="tech-icon"
            ...
            <img
              className="tech-icon"
              src="img/icons/adobephotoshop.svg"
              alt="adobephotoshop"
            />
             <img
              className="tech-icon"
              src="img/icons/adobeillustrator.svg"
              alt="adobeillustrator"
            />
             <img
              className="tech-icon"
              src="img/icons/adobeaftereffects.svg"
              alt="adobeaftereffects"
            />
             <img
              className="tech-icon"
              src="img/icons/adobepremiere.svg"
              alt="adobepremiere"
            />
            <img
              className="tech-icon"
              src="img/icons/finalcutprox.svg"
              alt="finalcutprox"
            />
            <img
              className="tech-icon"
              src="img/icons/Xcode.svg"
              alt="Xcode"
            />
            <img
              className="tech-icon"
              src="img/icons/AutodeskMaya.svg"
              alt="AutodeskMaya"
            />
            {/* Add more icons here */}
          </div>
