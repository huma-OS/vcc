            ...
            <form className="quiz-form text-light" onSubmit={handleSubmit}>
              ...
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q1" value="A" disabled={submitted}/>
                  <label className="form-check-label">10 pounds 8 ounces</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q1" value="B" disabled={submitted}/>
                  <label className="form-check-label">8 pounds</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q1" value="C" disabled={submitted}/>
                  <label className="form-check-label">8 pounds 10 ounces</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q1" value="D" disabled={submitted}/>
              ...
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q2" value="A" disabled={submitted}/>
                  <label className="form-check-label">Reasonable Doubt, Friend or Foe</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q2" value="B" disabled={submitted}/>
                  <label className="form-check-label">Kingdom Come, Hollywood</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q2" value="C" disabled={submitted}/>
                  <label className="form-check-label">
                    The Dynasty: Roc La Familia, You, Me, Him and Her
                  </label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q2" value="D" disabled={submitted}/>
              ...
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q3" value="A" disabled={submitted}/>
                  <label className="form-check-label">Rock and Soul</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q3" value="B" disabled={submitted}/>
                  <label className="form-check-label">Tower Records</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q3" value="C" disabled={submitted}/>
                  <label className="form-check-label">Beat Street Records</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q3" value="D" disabled={submitted}/>
              ...
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q4" value="A" disabled={submitted}/>
                  <label className="form-check-label">Kingdom Come</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q4" value="B" disabled={submitted}/>
                  <label className="form-check-label">Blueprint 2: The Gift and the Curse</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q4" value="C" disabled={submitted}/>
                  <label className="form-check-label">American Gangster</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q4" value="D" disabled={submitted}/>
              ...
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q5" value="A" disabled={submitted}/>
                  <label className="form-check-label">Jigga what, jigga who</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q5" value="B" disabled={submitted}/>
                  <label className="form-check-label">Can i get a…</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q5" value="C" disabled={submitted}/>
                  <label className="form-check-label">Anything</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q5" value="D" disabled={submitted}/>
              ...
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q6" value="A" disabled={submitted}/>
                  <label className="form-check-label">Heart of the city tour</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q6" value="B" disabled={submitted}/>
                  <label className="form-check-label">King and Queen of Hearts World Tour</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q6" value="C" disabled={submitted}/>
                  <label className="form-check-label">On the run tour</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q6" value="D" disabled={submitted}/>
              ...
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q7" value="A" disabled={submitted}/>
                  <label className="form-check-label">Three times</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q7" value="B" disabled={submitted}/>
                  <label className="form-check-label">Once</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q7" value="C" disabled={submitted}/>
                  <label className="form-check-label">Eight times</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q7" value="D" disabled={submitted}/>
              ...
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q8" value="A" disabled={submitted}/>
                  <label className="form-check-label">Blueprint</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q8" value="B" disabled={submitted}/>
                  <label className="form-check-label">4:44</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q8" value="C" disabled={submitted}/>
                  <label className="form-check-label">Vol 2 … Hard knock life</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q8" value="D" disabled={submitted}/>
              ...
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q9" value="C" disabled={submitted}/>
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q9" value="D" disabled={submitted}/>
              ...
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q10" value="A" disabled={submitted}/>
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q10" value="D" disabled={submitted}/>
              ...
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q11" value="A" disabled={submitted}/>
                  <label className="form-check-label">September 2001</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q11" value="B" disabled={submitted}/>
                  <label className="form-check-label">July 1999</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q11" value="C" disabled={submitted}/>
                  <label className="form-check-label">April 2005</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q11" value="D" disabled={submitted}/>
              ...
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q12" value="A" disabled={submitted}/>
                  <label className="form-check-label">560 state street</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q12" value="B" disabled={submitted}/>
                  <label className="form-check-label">46th Street and 6th ave</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q12" value="C" disabled={submitted}/>
                  <label className="form-check-label"> 540 W 26th St</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q12" value="D" disabled={submitted}/>
              ...
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q13" value="A" disabled={submitted}/>
                  <label className="form-check-label">Blueprint2: Gift and the curse</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q13" value="B" disabled={submitted}/>
                  <label className="form-check-label">The Black Album</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q13" value="C" disabled={submitted}/>
                  <label className="form-check-label"> Blueprint</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q13" value="D" disabled={submitted}/>
                  <label className="form-check-label">Kingdom Come</label>
                </div>
              </div>
              {/* Question 14 */}
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q14" value="A" disabled={submitted}/>
                  <label className="form-check-label">J. Cole, Wale, N.E.R.D., Trey Songz, Young Jeezy</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q14" value="B" disabled={submitted}/>
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q14" value="C" disabled={submitted}/>
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q14" value="D" disabled={submitted}/>
              ...
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q15" value="A" disabled={submitted}/>
                  <label className="form-check-label">July 15 2010</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q15" value="B" disabled={submitted}/>
                  <label className="form-check-label">April 5, 2005.</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q15" value="C" disabled={submitted}/>
                  <label className="form-check-label"> September 4, 2009. </label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q15" value="D" disabled={submitted}/>
              ...
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q17" value="A" disabled={submitted}/>
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q17" value="D" disabled={submitted}/>
              ...
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q18" value="A" disabled={submitted}/>
                  <label className="form-check-label">Afeni Shakur and Voletta Wallace</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q18" value="B" disabled={submitted}/>
                  <label className="form-check-label">Jamie Foxx and Kerry Washington</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q18" value="C" disabled={submitted}/>
                  <label className="form-check-label">Rhianna</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q18" value="D" disabled={submitted}/>
              ...
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q19" value="A" disabled={submitted}/>
                  <label className="form-check-label">Dean Sanders</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q19" value="B" disabled={submitted}/>
                  <label className="form-check-label">Shannon Sharpe</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q19" value="C" disabled={submitted}/>
                  <label className="form-check-label">Randy Moss</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q19" value="D" disabled={submitted}/>
              ...
              <div className="my-5">
                ...
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q20" value="A" disabled={submitted}/>
                  <label className="form-check-label">Excuse me miss</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q20" value="B" disabled={submitted}/>
                  <label className="form-check-label">Frontin</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q20" value="C" disabled={submitted}/>
                  <label className="form-check-label">I just wanna love you</label>
                </div>
                <div className="form-check my-2 text-white-50">
                  <input type="radio" name="q20" value="D" disabled={submitted}/>
